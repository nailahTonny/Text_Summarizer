...
# ---------- Streamlit UI ----------
st.set_page_config(page_title="AI Chat Summarizer", layout="wide")
...
if uploaded_file:
    ...
    if sentiment_scores:
        fig, ax = plt.subplots()
        ax.plot(sentiment_scores, color='#1f77b4', linewidth=2)
        ax.set_title("Sentiment Polarity Over Chat", fontsize=14, color='#1f77b4')
        ax.set_xlabel("Line Index", fontsize=12)
        ax.set_ylabel("Polarity (-1 to +1)", fontsize=12)
